...
<!-- Mirrored from byrushan.com/projects/mae/1-0/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2016 07:40:23 GMT -->
<head>
        <meta charset="utf-8">
    ...
    <body>
        <div class="login" data-lbg="teal">
            ...
            <div class="l-block toggled" id="l-login">
                ...
                {{ csrf_field() }}
                <div class="lb-body">
                    <div class="form-group fg-float {{ $errors->has('username') ? 'has-error' : '' }}">
                        <div class="fg-line">
                            <input type="text" class="input-sm form-control fg-input" name="username" value="{{ old('username') }}">
                    ...
                    <div class="form-group fg-float {{ $errors->has('password') ? ' has-error' : '' }}">
                        <div class="fg-line">
                            <input type="password" class="input-sm form-control fg-input" name="password">
                    ...
                    <div class="m-t-20">
                        <a data-bg="blue" class="palette-Teal text d-block m-b-5" href="{{ url('/') }}">Back To Home</a>
