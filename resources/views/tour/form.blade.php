                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <form action="{{route('tour.store')}}" method="post" class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group {{ (count($errors) > 0) ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="nama_tour" class="form-control" id="nama_tour" placeholder="Nama Tour">
                                            @if(count($errors) > 0)
                                    ...
                                    <div class="form-group {{ (count($errors) > 0) ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea name="deskripsi" style="height: 150px" class="form-control" id="deskripsi" placeholder="Deskripsi"></textarea>
                                            @if(count($errors) > 0)
