                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <form action="{{route('clothing.update',[$kaos->id])}}" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                ...
                                <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
                                    ...
                                    <div class="form-group {{ (count($errors) > 0) ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="nama_kaos" class="form-control" id="nama_kaos" placeholder="Nama Kaos" value="{{$kaos->nama_kaos}}">
                                            @if(count($errors) > 0)
                                    ...
                                    <div class="form-group {{ (count($errors) > 0) ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="ukuran" class="form-control" id="ukuran" placeholder="Ukuran" value="{{$kaos->ukuran}}" >
                                            @if(count($errors) > 0)
                                    ...
                                    <div class="form-group {{ (count($errors) > 0) ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="bahan" class="form-control" id="bahan" placeholder="Bahan" value="{{$kaos->bahan}}">
                                            @if(count($errors) > 0)
                                    ...
                                    <div class="form-group {{ (count($errors) > 0) ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="sablon" class="form-control" id="sablon" placeholder="Sablom" value="{{$kaos->sablon}}" >
                                            @if(count($errors) > 0)
                                                <span class="help-block">{{ $errors->first('bahan') }}</span>
                                            @endif
                                        </div>
                                    ...
                                    <div class="form-group {{ (count($errors) > 0) ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="warna" class="form-control" id="warna"
                                                   placeholder="Warna" value="{{$kaos->warna}}">
                                            @if(count($errors) > 0)
                                    ...
                                    <div class="form-group {{ (count($errors) > 0) ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="harga" class="form-control" id="harga"
                                                   placeholder="Harga" value="{{$kaos->harga}}">
                                            @if(count($errors) > 0)
                                    ...
                                    <div class="form-group {{ (count($errors) > 0) ? 'has-error' : ''}}">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" name="stok" class="form-control" id="stok" placeholder="Stok" value="{{$kaos->stok}}" >
                                            @if(count($errors) > 0)
